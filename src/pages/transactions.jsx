  ...
  const tableRow = [
    {
      ...
      description: "Deposit",
      balance: 10000,
      created_at: "2022-11-10T20:04:06.000Z",
    },
  ];
  return (
    <div>
      ...
      <div className="between pt-8">
        ...
        <div className="end space-x-3 xl:space-x-5">
          <Button className="bg-warning-soft text-primary rounded-lg py-3">
            <svg
              className="w-4 h-4"
              viewBox="0 0 18 18"
              fill="none"
        ...
        <Table className="w-full">
          ...
          <TableBody>
            {tableRow.map((item, idx) => {
              return (
                <TableRow key={idx}>
                  <td className="xl:w-[5%]">{item?.user_id}</td>

                  <td className="xl:w-[12%]">
                    {`\u20A6`} {item?.amount}
                  </td>

                  <td className="xl:w-[18%]">{item?.card_id}</td>
